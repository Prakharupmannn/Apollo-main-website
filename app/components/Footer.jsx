...
import { Stethoscope, PhoneCall, Mail, MapPin, Send, ShieldCheck, Globe, Share2, MessageCircle, Video, ChevronRight, HeartPulse, Sparkles } from "lucide-react";

export default function Footer({ onOpenAppointmentModal }) {
  return (
    <footer id="footer" className="bg-gradient-to-b from-[#0A5F7A] via-[#2A8FAF] to-[#17627D] text-white pt-20 pb-10 border-t border-[#1D82A6]/40 relative overflow-hidden group/footer select-none">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/3 w-[25rem] h-[25rem] bg-[#1D82A6]/30 rounded-full blur-[100px] animate-pulse-slow" style={{ animationDelay: '3s' }} />

        {/* Dynamic Animated Grid Pattern */}
        <div 
          className="absolute inset-0 opacity-[0.15] animate-grid" 
          style={{ 
            backgroundImage: "radial-gradient(#1D82A6 1.2px, transparent 1.2px)", 
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-8">
          ...
          <div className="bg-gradient-to-r from-[#EDF6FB] via-[#F4FAFC] to-[#D5EBF7] text-slate-800 rounded-[calc(2.5rem-2px)] p-8 sm:p-12 relative overflow-hidden flex flex-col md:flex-row md:items-center justify-between gap-8 border border-white/80 backdrop-blur-md">
            ...
            <div className="space-y-3 relative z-10 max-w-2xl">
              ...
              <h3 className="font-serif-apollo text-2xl sm:text-3xl lg:text-4xl font-black tracking-tight text-[#0B3446] leading-tight">
                Healthier People, <span className="bg-gradient-to-r from-[#0E526B] via-[#17627D] to-[#C8952E] bg-clip-text text-transparent">Brighter Tomorrows</span>
              </h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 pb-16 border-b border-white/15">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2.5 text-xs text-slate-100/90 font-medium">
              {[
                ...
                <li key={idx}>
                  <a href={link.href} className="group/link hover:text-[#F6D98A] flex items-center gap-1.5 transition-all duration-200">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2.5 text-xs text-slate-100/90 font-medium">
              <li>
                <button onClick={onOpenAppointmentModal} className="group/btn hover:text-[#F6D98A] flex items-center gap-1.5 transition-all duration-200 text-left cursor-pointer">
                  <ChevronRight className="w-3.5 h-3.5 text-[#C8952E] transition-transform duration-200 group-hover/btn:translate-x-1" />
                  <span className="transition-transform duration-200 group-hover/btn:translate-x-0.5">Book Doctor Appointment</span>
                </button>
              </li>
              <li>
                <a href="#specialities" className="group/link hover:text-[#F6D98A] flex items-center gap-1.5 transition-all duration-200">
                  <ChevronRight className="w-3.5 h-3.5 text-[#C8952E] transition-transform duration-200 group-hover/link:translate-x-1" />
                  <span className="transition-transform duration-200 group-hover/link:translate-x-0.5">Health Check Packages</span>
                </a>
              </li>
              <li>
                <a href="#" className="group/link hover:text-[#F6D98A] flex items-center gap-1.5 transition-all duration-200">
                  <ChevronRight className="w-3.5 h-3.5 text-[#C8952E] transition-transform duration-200 group-hover/link:translate-x-1" />
                  <span className="transition-transform duration-200 group-hover/link:translate-x-0.5">Speciality Clinics & Diagnostics</span>
                </a>
              </li>
              <li>
                <a href="#" className="group/link hover:text-[#F6D98A] flex items-center gap-1.5 transition-all duration-200">
                  <ChevronRight className="w-3.5 h-3.5 text-[#C8952E] transition-transform duration-200 group-hover/link:translate-x-1" />
                  <span className="transition-transform duration-200 group-hover/link:translate-x-0.5">Patient & Visitor Guidelines</span>
                </a>
              </li>
              <li className="pt-3">
                <a href="tel:1066" className="inline-flex items-center gap-2 px-4 py-2.5 rounded-2xl bg-red-500/20 text-red-200 border border-red-500/40 font-bold hover:bg-red-600 hover:text-white transition-all duration-300 shadow-lg hover:shadow-red-500/30 transform hover:-translate-y-0.5 backdrop-blur-sm">
          ...
          <div className="space-y-4">
            ...
            <form onSubmit={(e) => e.preventDefault()} className="flex items-center bg-white/10 rounded-full p-1.5 border border-white/25 focus-within:border-[#F6D98A] focus-within:ring-2 focus-within:ring-[#F6D98A]/30 transition-all backdrop-blur-md shadow-inner">
              <input
                type="email"
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between text-xs text-slate-200/90 gap-4 font-medium">
          ...
          <div className="flex items-center gap-4 text-slate-300">
            <a href="#" className="hover:text-[#F6D98A] transition-colors">Privacy Policy</a>
            <span className="opacity-40">•</span>
            <a href="#" className="hover:text-[#F6D98A] transition-colors">Terms of Service</a>
            <span className="opacity-40">•</span>
            <a href="#" className="hover:text-[#F6D98A] transition-colors">Sitemap</a>
          </div>
        </div>
